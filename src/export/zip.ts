// Minimal ZIP archive writer with ZERO dependencies, using the native
// CompressionStream('deflate-raw') where available; falls back to storing
// entries uncompressed so the archive is still valid everywhere.
